...
all_news_df %>%
  ...
  rio::export(here("data", "who_dons_20250911.csv"))
```

## Pivot data into long format

```{r}
corpus <- import(here("data/who_dons_20250911.csv")) %>%
  select(
    UrlName,
    DonId,
...
export(corpus, here("data", "corpus_20250911.csv"))
```
